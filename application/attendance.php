			...
			<div class="col-lg-12">
				...
				<br />
					...
					<div class="card-header">
						...
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button" id="new_attendance_btn"><span class="fa fa-plus"></span> Loan Repayment(MAREJESHO)</button>
					</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#new_attendance_btn').click(function(){
				uni_modal("New Time Record/s","manage_attendance.php",'large')
			})
