...
$select = mysqli_query($conn, "SELECT * FROM trans WHERE ID= '3307' ORDER BY GroupNo") or die (mysqli_error($conn));
...
?>
		<td><input name="Tdate[]" type = "date" size ="5" value="<?php echo $Tdate; ?>"></td>

		<td><input name="TRECEPT[]"  value="<?php echo $TRECEPT; ?>" size ="1"></td>


			<td><input name="Branchcode[]"  value="<?php echo $Branchcode; ?>" size ="26"></td>

		<td>
			<input name="ScheduleAmount[]"  type="select" size ="16">
		</td>

		<td><input name="descript[]"  size ="26"></td>


		<td><input name="typecode[]"  value="EXPENSE" size ="26"></td>
