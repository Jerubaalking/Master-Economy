...
if($image == "")
{
	$update = mysqli_query($conn,"UPDATE user SET name='$name',email='$email',phone='$phone',addr1='$addr1',addr2='$addr2',city='$city',state='$state',zip='$zip',country='$country',comment='$comment',username='$username',password='$encrypt' WHERE userid ='$id'")or die(mysqli_error());
	if(!$update)
	{
	...
	elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
	{
		...
		$update = mysqli_query($conn,"UPDATE user SET name='$name',email='$email',phone='$phone',addr1='$addr1',addr2='$addr2',city='$city',state='$state',zip='$zip',country='$country',comment='$comment',username='$username',password='$encrypt',image='$location' WHERE userid ='$id'")or die(mysqli_error()); 
		if(!$update)
		{
			echo '<meta http-equiv="refresh" content="2;url=view_emp.php?tid='.$id.'&&mid='.base64_encode("409").'">';
			echo '<br>';
