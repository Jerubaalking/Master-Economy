...
<?php }}?>
  ...
  <div class="content-wrapper">
	...
	<div class="box">
            ...
            <h3 class="panel-title"><i class="fa fa-envelope"></i> Read/Reply Message</h3>
            </div>
             <div class="box-body">
		...
		<?php echo '<div class="alert alert-info fade in" >
			...
			<div class="form-group">
              ...
              <div class="box-footer">
                				...
                				<button name="save" type="submit" class="btn btn-success btn-flat"><i class="fa fa-save">&nbsp;Reply Now</i></button>
