  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12">
		...
		{
?>
           <div style="color:#009900"><div style="font-size:10px"><div align="center"><?php echo '&nbsp;&nbsp;&nbsp;'. $row ['name'];?></div></div></div>
		   <small class="pull-left"><div style="color:#009900">LOAN REPORT - January to August 2022</div></small>
...
$select = mysqli_query($conn, "SELECT * FROM trans WHERE Tdate> '2021-12-31' AND Tdate<'2022-09-01' AND Special = 'loanx' ORDER BY Tdate, TRECEPT") or die (mysqli_error($conn));
