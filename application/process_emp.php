...
$cpaswword =  mysqli_real_escape_string($conn, $_POST['cpassword']);
$role =  "admin";
...
//	echo '<meta http-equiv="refresh" content="2;url=view_emp.php?tid='.$id.'&&mid='.base64_encode("409").'">';
	//echo '<br>';
//	echo'<span class="itext" style="color: #FF0000">Already existsss.</span>';
//}
...
elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
{
	...
	$insert = mysqli_query($conn, "INSERT INTO user VALUES('','$name','$email','$phone','$addr1','$addr2','$city','$state','$zip','$country','$comment','$username','$encrypt','$id','$location','$role')") or die (mysqli_error($conn));
	if(!$insert)
	{
