...
$w=array(15,40,20,15,20,38,30,20,18,15,15,15,15);
	...
	{ //width
	    $this->Cell(15,6,$eachResult["id"],1);
		$this->Cell(40,6,$eachResult["tname"],1);
		$this->Cell(20,6,$eachResult["template"],1);
		$this->Cell(15,6,$eachResult["desc"],1);
		$this->Cell(20,6,$eachResult["created_by"],1);
		$this->Ln();
...
$header=array('ID','Name','Template','Description','Date Created');
//Data loading
//*** Load MySQL Data ***//
//db settings
...
$pdf->AddPage();
	...
	$select = mysqli_query($conn, "SELECT * FROM etemplates") or die (mysqli_error($conn));
	$count = mysqli_num_rows($result);
	$pdf->Cell(0);
	$pdf->Write(5, ' All Total Templates : '.$count.'');
	$pdf->Ln();
