...
$w=array(20,20,40,30,30,25,30,20,18,15,15,15,15);
	...
	{ //width
		$this->Cell(20,6,$eachResult["account"],1);
	    $this->Cell(20,6,$eachResult["fname"],1);
		$this->Cell(40,6,$eachResult["email"],1);
		$this->Cell(30,6,$eachResult["phone"],1);
		$this->Cell(30,6,$eachResult["city"],1);
		$this->Cell(25,6,$eachResult["country"],1);
...
$pdf=new PDF();
$header=array('Account No.','First Name','Email','Phone Number','City','Country','Balance');
//Data loading
//*** Load MySQL Data ***//
//db settings
...
$pdf->AddPage();
	...
	$pdf->Cell(70);
	$pdf->Write(7, 'LIST ALL CUSTOMERS');
	$pdf->Ln();
