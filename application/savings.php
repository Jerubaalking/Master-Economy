	...
	<li><a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-book"></i> <span>My Wallet</span></a></li>
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
			...
			<li class="active"><a href="backupdatabase.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Backup Database</a></li>
          </ul>
        </li>
		<li>
          <a href="../logout.php">
...
<div align="center"><a href="dashboard.php?tid<?php echo $_SESSION['tid']; ?>" class="btn btn-success btn-flat"><i class="fa fa-send"></i>&nbsp;MODULE COMING SOON!</a></div>
