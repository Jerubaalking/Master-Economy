...
<?php
$id = $_GET['id'];
$acte =  mysqli_real_escape_string($conn, $_POST['acte']);
$account_no = mysqli_real_escape_string($conn, $_POST['account']);
...
$update = mysqli_query($conn,"UPDATE payments SET account='$acte',account_no='$account_no',customer='$customer',loan='$loan',pay_date='$pay_date',amount_to_pay='$amount_to_pay',remarks='$remarks' WHERE id ='$id'")or die(mysqli_error());
if(!$update)
{
