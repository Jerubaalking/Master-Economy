<?php
$select = mysqli_query($conn, "SELECT * FROM loan_info") or die (mysqli_error($conn));
...
<legend>Edit Status</legend>
        ...
        <div class="modal-body">
		  ...
		  <form class="form-horizontal" method="post"  enctype="multipart/form-data">
				  ...
				  <div class="col-sm-10">
				  <select name="Status" class="form-control select2 " multiple="multiple" data-placeholder="Status" style="width: 100%;">
								...
								<button class="btn btn-flat btn-danger" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Close</button>
									...
									mysqli_query($conn,"UPDATE loan_info SET status='$Status_save'
									WHERE id = '$UserID'")or die(mysqli_error());
									echo "<script>window.location='listloans.php?id=".$id."'; </script>";
