...
elseif($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg" && $imageFileType != "gif")
{
	...
	$insert = mysqli_query($conn, "INSERT INTO borrowers VALUES('','$fname','$lname','$email','$phone','$addrs1','$addrs2','$city','$state','$zip','$country','','$account','0.0','$location',NOW(),'$status')") or die (mysqli_error($conn));
	if(!$insert)
	{
