...
$date = date("d/m/Y",$get);
$select = mysqli_query($conn, "SELECT * FROM loan_info WHERE pay_date >= '$date' AND pay_date < '$date'") or die (mysqli_error($conn));
...
$selectin = mysqli_query($conn, "SELECT fname, lname FROM borrowers WHERE id = '$borrower'") or die (mysqli_error($conn));
