<div class="row">
  ...
  crossorigin="anonymous"></script>
	...
	<a href="printpayment-daily.php" target="_blank" class="btn btn-primary btn-flat"><i class="fa fa-print"></i>&nbsp;Print Payments</a>
...
?>
            ...
            <div class="box-body">
            <div class="alert alert-info" align="center" class="style2" style="color: #FFFFFF">NUMBER OF LOAN TRANSACTIONS:&nbsp;
			<?php
			$call3 = mysqli_query($conn, "SELECT * FROM Trans WHERE Branchcode = 'loan'");
