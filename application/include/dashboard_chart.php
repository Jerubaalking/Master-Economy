...
<h4>
<?php
$select = mysqli_query($conn, "SELECT SUM(Dramount) FROM trans  WHERE Branchcode = 'Loan'") or die (mysqli_error($conn));
while($row = mysqli_fetch_array($select))
{
$select1 = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
while($row1 = mysqli_fetch_array($select1))
{
$currency = $row1['currency'];
echo $currency.number_format($row['SUM(Dramount)'],2,".",",")."</b>";
}
}
?>
</h4>
...
?>
       <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT * FROM borrowers WHERE comment != ''") or die (mysqli_error($conn));
...
?>
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT * FROM user") or die (mysqli_error($conn));
$num = mysqli_num_rows($select);
echo $num;
?>
			</h4>
...
?>
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
$num = mysqli_num_rows($select);
echo $num;
?>
			</h4>
...
?>
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT * FROM message") or die (mysqli_error($conn));
$num = mysqli_num_rows($select);
echo $num;
?>
			</h4>
...
?>
          ...
          <div class="small-box bg-yellow">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT SUM(amount) FROM loan_info") or die (mysqli_error($conn));
while($row = mysqli_fetch_array($select))
{
$select1 = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
while($row1 = mysqli_fetch_array($select1))
...
?>
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT SUM(Cramount) FROM trans  WHERE Branchcode = 'Loan'") or die (mysqli_error($conn));
while($row = mysqli_fetch_array($select))
{
$select1 = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
while($row1 = mysqli_fetch_array($select1))
{
$currency = $row1['currency'];
echo $currency.number_format($row['SUM(Cramount)'],2,".",",")."</b>";
}
}
?>
			</h4>
...
?>
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT SUM(amount) FROM transaction WHERE t_type = 'Withdraw'") or die (mysqli_error($conn));
while($row = mysqli_fetch_array($select))
{
$select1 = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
while($row1 = mysqli_fetch_array($select1))
...
?>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
			...
			<h4>
<?php
$selecte = mysqli_query($conn, "SELECT * FROM transaction") or die (mysqli_error($conn));
...
?>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
			...
			<h4>
<?php
$select = mysqli_query($conn, "SELECT SUM(amount) FROM transaction WHERE t_type = 'Deposit'") or die (mysqli_error($conn));
while($row = mysqli_fetch_array($select))
{
$select1 = mysqli_query($conn, "SELECT * FROM systemset") or die (mysqli_error($conn));
while($row1 = mysqli_fetch_array($select1))
