...
<div class="box-body">
			...
			<div class="form-group">
                ...
                <select name="tide"  class="form-control select2" required>
					<?php
					$search_user = mysqli_query($conn, "SELECT * FROM user WHERE id != '".$_SESSION['tid']."'") or die ("Error: " . mysqli_error($conn));
...
{
//$id = $_POST['selector'];
$tide = mysqli_real_escape_string($conn, $_POST['tide']);

$verify = mysqli_query($conn, "SELECT * FROM emp_permission WHERE tid = '$tide'") or die ("Error: " . mysqli_error($conn));
...
$module1 = mysqli_real_escape_string($conn, $_POST['email_t']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module1','$pcreate1','$pread1','$pupdate1','$pdelete1')") or die ("Error: " . mysqli_error($conn));
//End of first module

//Starting of second module
$module2 = mysqli_real_escape_string($conn, $_POST['borrow_d']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module2','$pcreate2','$pread2','$pupdate2','$pdelete2')") or die ("Error: " . mysqli_error($conn));
//End of second module

//Starting of third module
$module3 = mysqli_real_escape_string($conn, $_POST['wallet']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module3','$pcreate3','$pread3','$pupdate3','$pdelete3')") or die ("Error: " . mysqli_error($conn));
//End of third module

//Starting of fourth module
$module4 = mysqli_real_escape_string($conn, $_POST['loan_d']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module4','$pcreate4','$pread4','$pupdate4','$pdelete4')") or die ("Error: " . mysqli_error($conn));
//End of fourth module

//Starting of fifth module
$module5 = mysqli_real_escape_string($conn, $_POST['msg']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module5','$pcreate5','$pread5','$pupdate5','$pdelete5')") or die ("Error: " . mysqli_error($conn));
//End of fifth module

//Starting of sixth module
$module6 = mysqli_real_escape_string($conn, $_POST['mpay']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module6','$pcreate6','$pread6','$pupdate6','$pdelete6')") or die ("Error: " . mysqli_error($conn));
//End of sixth module

//Starting of seventh module
$module7 = mysqli_real_escape_string($conn, $_POST['payment']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module7','$pcreate7','$pread7','$pupdate7','$pdelete7')") or die ("Error: " . mysqli_error($conn));
//End of seventh module

//Starting of eight module
$module8 = mysqli_real_escape_string($conn, $_POST['emp_d']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module8','$pcreate8','$pread8','$pupdate8','$pdelete8')") or die ("Error: " . mysqli_error($conn));
//End of eight module

//Starting of ninth module
$module9 = mysqli_real_escape_string($conn, $_POST['permission_m']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module9','$pcreate9','$pread9','$pupdate9','$pdelete9')") or die ("Error: " . mysqli_error($conn));
//End of ninth module

//Starting of tenth module
$module10 = mysqli_real_escape_string($conn, $_POST['savings_t']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module10','$pcreate10','$pread10','$pupdate10','$pdelete10')") or die ("Error: " . mysqli_error($conn));
//End of tenth module

//Starting of eleventh module
$module11 = mysqli_real_escape_string($conn, $_POST['general_t']);
...
$insert1 = mysqli_query($conn, "INSERT INTO emp_permission VALUES('','$tide','$module11','$pcreate11','$pread11','$pupdate11','$pdelete11')") or die ("Error: " . mysqli_error($conn));
