...
<?php } ?>
	...
	<hr>
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$select = mysqli_query($conn, "SELECT * FROM borrowers ORDER BY 'Group'") or die (mysqli_error($conn));
...
<?php
$se = mysqli_query($conn, "SELECT * FROM battachment WHERE get_id = '$id'") or die (mysqli_error($conn));
