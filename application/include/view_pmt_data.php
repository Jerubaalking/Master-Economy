...
<?php
$id = $_GET['id'];
$select = mysqli_query($conn, "SELECT * FROM payments WHERE id = '$id'") or die (mysqli_error($conn));
...
?>
			...
			<div class="form-group">
                ...
                <select class="customer select2" name="customer" style="width: 100%;">
                 <?php
				$get = mysqli_query($conn, "SELECT * FROM borrowers WHERE id = '$id'") or die (mysqli_error($conn));
		 ...
		 <div class="form-group">
                ...
                <select class="account select2" name="account" style="width: 100%;">
                  <?php
				$getin = mysqli_query($conn, "SELECT * FROM borrowers WHERE id = '$id'") or die (mysqli_error($conn));
			  ...
			  <div class="form-group">
                ...
                <select class="loan select2" name="loan" style="width: 100%;">
                 <?php
				$get = mysqli_query($conn, "SELECT * FROM loan_info WHERE borrower = '$id'") or die (mysqli_error($conn));
				while($rows = mysqli_fetch_array($get))
				{
...
<?php
$id = $_GET['id'];
$selected = mysqli_query($conn, "SELECT * FROM payments WHERE id = '$id'") or die (mysqli_error($conn));
...
<?php
$id = $_GET['id'];
$selecte = mysqli_query($conn, "SELECT * FROM user WHERE id = '".$_SESSION['tid']."'") or die (mysqli_error($conn));
