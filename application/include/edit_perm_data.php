...
$id = $_GET['id'];
$i = 0;
$search = mysqli_query($conn, "SELECT * FROM emp_permission WHERE tid = '$id'") or die (mysqli_error($conn));
...
$update_sel = mysqli_query($conn, "UPDATE emp_permission SET pcreate = '$pcreate', pread = '$pread', pupdate ='$pupdate', pdelete ='$pdelete' WHERE id ='$s'") or die ("Error: " . mysqli_error($conn));
$i++;
